...
Begin VB.Form FrmInput 
   ...
   Begin VB.ComboBox CmbPickShape 
      ...
      Left            =   1680
      TabIndex        =   17
      ToolTipText     =   "Sets the pickshape"
      Top             =   480
      Width           =   1815
   End
   Begin VB.TextBox Text8 
      ...
      TabIndex        =   7
      Text            =   "0"
      ToolTipText     =   "Sets the position of the receiver"
      Top             =   3120
      Width           =   1575
   End
   Begin VB.TextBox Text7 
      ...
      TabIndex        =   6
      Text            =   "0"
      ToolTipText     =   "Sets the position of the exciter"
      Top             =   2760
      Width           =   1575
   End
   ...
   Begin VB.TextBox Text6 
      ...
      TabIndex        =   5
      Text            =   "0"
      ToolTipText     =   "Sets the damper constant 3"
      Top             =   2280
      Width           =   1575
   End
   Begin VB.TextBox Text5 
      ...
      TabIndex        =   4
      Text            =   "0"
      ToolTipText     =   "Sets the damper constant 2"
      Top             =   1920
      Width           =   1575
   End
   Begin VB.TextBox Text4 
      ...
      TabIndex        =   3
      Text            =   "0"
      ToolTipText     =   "Sets the damper constant 1"
      Top             =   1560
      Width           =   1575
   End
   Begin VB.TextBox Text3 
      ...
      TabIndex        =   2
      Text            =   "0"
      ToolTipText     =   "Sets the dispersion "
      Top             =   1200
      Width           =   1575
   End
   Begin VB.TextBox Text2 
      ...
      TabIndex        =   1
      Text            =   "0"
      ToolTipText     =   "Sets the tension force of the string (higher value = higher freq), use carefully it may cut the string"
      Top             =   840
      Width           =   1575
   End
   Begin VB.TextBox Text1 
      ...
      Left            =   1680
      TabIndex        =   0
      ToolTipText     =   "Sets the amount of elements of the String (more => deeper frequ)"
      Top             =   120
      Width           =   1575
   End
